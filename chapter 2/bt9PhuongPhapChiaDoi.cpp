...
long double f(long double x){
    return exp(x)-2-cos(exp(x)-2);   //phương trình
}
...
int main(){
    ...
    long double endPoint1=0.5;  // 2 đầu mút.
    long double endPoint2=1.5;
    ...
    for (int i=1;i<=NumOfIteration;i++){
        ...
        cout<<setw(20)<<fixed<<setprecision(15)<<midPoint(endPoint1,endPoint2);
